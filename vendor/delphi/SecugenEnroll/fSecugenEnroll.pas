...
begin
  Ffuncionario.Digital := digital;
  FDados.salvar_funcionario(Ffuncionario);
...
begin
  ...
  try
    ...
    begin
      if capturar(digital, erro, cancelado) then
      begin
...
begin
  Ffuncionario := FDados.carregar_funcionario(edtMatricula.Text);
  if Ffuncionario.NaoEncontrado then
  begin
  ...
  begin
    ...
    lblNome.Caption := 'Nome: ' + Ffuncionario.Nome;
    lblMatricula.Caption := 'Matrícula: ' + Ffuncionario.Matricula;
